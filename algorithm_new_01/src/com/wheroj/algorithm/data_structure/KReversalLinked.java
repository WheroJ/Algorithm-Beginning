...
public class KReversalLinked {
    ...
    private static LinkedReversal.Node<Integer> reversal(LinkedReversal.Node<Integer> start, LinkedReversal.Node<Integer> end) {
        ...
        LinkedReversal.Node<Integer> pre = end;
    ...
    public static LinkedReversal.Node<Integer> f(LinkedReversal.Node<Integer> node, int K) {
        LinkedReversal.Node<Integer> stageEnd = getK(node, K);
        LinkedReversal.Node<Integer> pre = null;
        while (stageEnd != null) {
            System.out.println(stageEnd.value);
            if (pre == null) {
                pre = reversal(node, stageEnd);
                print(pre);
            } else {
